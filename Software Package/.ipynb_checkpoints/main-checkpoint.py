...
if __name__ == '__main__':
	...
	if (args.option == 1): # manual features
		subprocess.call(["python","manual_features.py", args.datapath, args.n_datatypes, args.magnification_level])
	elif (args.option == 2): # AEs
		subprocess.call(["python","AE.py", args.datapath, args.n_datatypes, args.magnification_level])
